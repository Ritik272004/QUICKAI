...
const SideBar = (props) => {
  ...
  return (
    ...
    justify-between items-center max-sm:absolute top-14 bottom-0 ${props.sidebar ? 'translate-x-0' : 'max-sm:translate-x-full'} transition-all duration-300
    ease-in-out`}>
        <div className='my-7 w-full'>
            ...
            <div className='px-6 mt-5 text-sm text-gray-600 font-medium'>
                {navItems.map(({to , label , Icon}) => (
                  <NavLink key={to} to={to} end={to === '/ai'} onClick={() => props.setSideBar(false)} 
