...
const RemoveBackground = () => {
  ...
  return (
    ...
    text-slate-700'>
        {/* Left Column */}
        <form onSubmit={handleSubmit} className='w-full max-w-lg p-4 bg-white rounded-lg border
          border-gray-200'>
            ...
            <button disable={loading} className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#f6ab41] to-[#ff4938] text-whitepx-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
          ...
          {/* Right Column */}
           ...
           border-gray-200 min-h-96'>
...

              {
                ...
                <img src={content} className='w-full h-full mt-3' alt="image" />
              )
              }
